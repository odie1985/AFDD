...
namespace KARO_AFDD
{
    public partial class frm9922 : Form
    {
        #region fields
        ...
        private void frm9922_Load(object sender, EventArgs e)
        {
        ...
        private void DO_btnStart_Click(object sender, EventArgs e)
        {
            if (DI_Check(2) == 1)
            {
                ...
                else if (cbxCurrentChoose.Text == "6A")
                {
                    do
                    {
                        DO_Click(3, 65);    //S309 S315
                    } while ((int)DI_Check(3) == 65);
                ...
                else if (cbxCurrentChoose.Text == "13A")
                {
                    do
                    {
                        DO_Click(3, 161);    //S309 S314 S316
                    } while ((int)DI_Check(3) == 161);
                }
                else if (cbxCurrentChoose.Text == "20A")
                {
                    do
                    {
                        DO_Click(3, 17);    //S309 S313
                    } while ((int)DI_Check(3) == 17);
                }
                else if (cbxCurrentChoose.Text == "40A")
                {
                    do
                    {
                        DO_Click(3, 9);    //S309 S312
                    } while ((int)DI_Check(3) == 9);
                }
                else if (cbxCurrentChoose.Text == "63A")
                {
                    do
                    {
                        DO_Click(3, 5);    //S309 S311
                    } while ((int)DI_Check(3) == 5);
                }
                else
                {
                    return;
