...
namespace KARO_AFDD
{
    public partial class frm99427 : Form
    {
        #region fields
        ...
        private void frm99427_Load(object sender, EventArgs e)
        {
        ...
        private void SchematicA()
        {
            ...
            {
                DO_Click(7, 128);    //S416
            } while ((int)DI_Check(7) == 128);

            do
            {
                DO_Click(4, 16);    //S321
            } while ((int)DI_Check(4) == 16);
        ...
        private void SchematicB()
        {
            ...
            {
                DO_Click(7, 64);    //S415
            } while ((int)DI_Check(7) == 64);

            do
            {
                DO_Click(3, 1);     //S309
            } while ((int)DI_Check(3) == 1);

            do
            {
                DO_Click(4, 15);     //S317 S318 S319 S320
            } while ((int)DI_Check(4) == 15);
        ...
        private void SchematicC()
        {
            ...
            do
            {
                DO_Click(4, 23);     //S317 S318 S319 S321
            } while ((int)DI_Check(4) == 23);
