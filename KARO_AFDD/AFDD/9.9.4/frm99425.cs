...
namespace KARO_AFDD
{
    public partial class frm99425 : Form
    {
        #region fields
        ...
        private void frm99425_Load(object sender, EventArgs e)
        {
        ...
        private void SchematicA()
        {
            ...
            {
                DO_Click(7, 8);    //S412
            } while ((int)DI_Check(7) == 8);

            do
            {
                DO_Click(8, 63);    //S417 - S422
            } while ((int)DI_Check(8) == 63);
