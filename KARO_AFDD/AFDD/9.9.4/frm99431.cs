...
namespace KARO_AFDD
{
    public partial class frm99431 : Form
    {
        #region fields
        ...
        private void frm99431_Load(object sender, EventArgs e)
        {
        ...
        private void ArcGenerator()
        {
            ...
            do
            {
                DO_Click(6, 65);    //S401 S407
            } while ((int)DI_Check(6) == 65);
