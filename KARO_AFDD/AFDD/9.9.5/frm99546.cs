...
namespace KARO_AFDD
{
    public partial class frm99546 : Form
    {
        #region fields
        ...
        private void frm99546_Load(object sender, EventArgs e)
        {
        ...
        {
            txtSamples.Text = (int.Parse(txtClockRate.Text) * 50).ToString();
        }
