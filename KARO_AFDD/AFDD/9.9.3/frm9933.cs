...
namespace KARO_AFDD
{
    public partial class frm9933 : Form
    {
        #region fields
        ...
        private void frm9933_Load(object sender, EventArgs e)
        {
        ...
        private void DO_btnStart_Click(object sender, EventArgs e)
        {
            if (DI_Check(2) == 1)
            {
                if (cbxCurrentChoose.Text == "75A")
                {
                    do
                    {
                        DO_Click(3, 36);    //S311 S314
                    } while ((int)DI_Check(3) == 36);
                }
                else if (cbxCurrentChoose.Text == "100A")
                {
                    do
                    {
                        DO_Click(3, 12);    //S311 S312
                    } while ((int)DI_Check(3) == 12);

                    
                }
                else if (cbxCurrentChoose.Text == "150A")
                {
                    do
                    {
                        DO_Click(3, 252);    //S311 - S319
                    } while ((int)DI_Check(3) == 252);
        ...
        private void Current_Calculate(double[] m_data)
        {
            for (int i = 0; i < m_data.Length; i++)
            {
                ...
                {
                    m_dataScaled_I[i] = m_data[i] * 32 - 2.1;
                }
                else if (cbxChannelCount.Text == "3")
                {
                    m_dataScaled_I[i] = m_data[i] * 110 - 2;
                }
            }
        }
        ...
        private void CarbonationTest()
        {
            do
            {
                DO_Click(2, 44);    //S303 S304 S306
            } while ((int)DI_Check(2) == 44);
