...
namespace KARO_AFDD
{
    public partial class frmAFD63318 : Form
    {
        #region fields
        ...
        private void frmAFD63318_Load(object sender, EventArgs e)
        {
        ...
        {
            txtSamples.Text = (int.Parse(txtClockRate.Text) * 60).ToString();
        }
        ...
        private void Sampling_getdata()
        {
            ...
            do
            {
                DO_Click(12, 128);    //S524
            } while ((int)DI_Check(12) == 128);
        }
