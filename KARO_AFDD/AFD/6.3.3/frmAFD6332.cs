...
namespace KARO_AFDD
{
    public partial class frmAFD6332 : Form
    {
        #region fields
        ...
        private void frmAFD6332_Load(object sender, EventArgs e)
        {
        ...
        //private void txtClockRate_TextChanged(object sender, EventArgs e)
        //{
        //    txtSamples.Text = (int.Parse(txtClockRate.Text) * 10).ToString();
        //}
        ...
        private void ArcGenerator()
        {
            do
            {
                DO_Click(2, 112);    //S305 S306 S307
            } while ((int)DI_Check(2) == 112);

            do
            {
                DO_Click(3, 2);    //S310
            } while ((int)DI_Check(3) == 2);
        ...
        private void Sampling_A()
        {
            ...
            do
            {
                DO_Click(2, 122);    //S302 S304
            } while ((int)DI_Check(2) == 122);
