...
namespace KARO_AFDD
{
    public partial class frmAFD634111 : Form
    {
        #region fields
        ...
        private void frmAFD634111_Load(object sender, EventArgs e)
        {
        ...
        private void DO_btnStart_Click(object sender, EventArgs e)
        {
            if (DI_Check(2) == 1)
            {
                if (cbxArcGear.Text == "电弧发生器")
                {
                    ArcGenerator();
                }
                else if (cbxArcGear.Text == "碳化电缆试品")
                {
                    CarbonationTest();
                }
            }
        ...
        private void ArcGenerator()
        {
            ...
            if (cbxCircuitConfig.Text == "图6")
            {
                SchematicC();
            }
            else if (cbxCircuitConfig.Text == "图7")
            {
                SchematicD();
            }
            else if (cbxCircuitConfig.Text == "图8")
            {
                SchematicA();
            }
            else if (cbxCircuitConfig.Text == "图9")
            {
                SchematicB();
            }
        ...
        private void SchematicB()
        {
            ...
            {
                DO_Click(10, 1);    //S501
            } while ((int)DI_Check(10) == 1);

            do
            {
                DO_Click(3, 129);     //S309 S316
            } while ((int)DI_Check(3) == 129);
        ...
        private void SchematicC()
        {
            ...
            {
                DO_Click(2, 204);   //S308
            } while ((int)DI_Check(2) == 204);

            do
            {
                DO_Click(3, 128);   //S316
            } while ((int)DI_Check(3) == 128);
        ...
        {
            if (cbxCircuitConfig.Text == "图A")
            {
                picSchematic.Image = global::KARO_AFDD.Properties.Resources.屏蔽A;
            }
            else if (cbxCircuitConfig.Text == "图B")
            {
                picSchematic.Image = global::KARO_AFDD.Properties.Resources.屏蔽B;
            }
            else if (cbxCircuitConfig.Text == "图C")
            {
                picSchematic.Image = global::KARO_AFDD.Properties.Resources.屏蔽C;
            }
            else if (cbxCircuitConfig.Text == "图D")
            {
                picSchematic.Image = global::KARO_AFDD.Properties.Resources.屏蔽D;
            }
        }
