...
namespace KARO_AFDD
{
    public partial class frmAFD63412 : Form
    {
        #region fields
        ...
        private void frmAFD63412_Load(object sender, EventArgs e)
        {
        ...
        private void ArcGenerator()
        {
            do
            {
                DO_Click(2, 68);    //S303 S307
            } while ((int)DI_Check(2) == 68);

            do
            {
                DO_Click(6, 8);    //S404
            } while ((int)DI_Check(6) == 8);

            do
            {
                DO_Click(7, 1);     //S409
            } while ((int)DI_Check(7) == 1);
