...
namespace KARO_AFDD
{
    public partial class frmAFD63221 : Form
    {
        #region fields
        ...
        private void frmAFD63221_Load(object sender, EventArgs e)
        {
        ...
        private void CarbonationTest()
        {
            ...
            if (cbxPower.Text == "4")
            {
                if (cbxPowerFactor.Text == "1")
                {
                    do
                    {
                        DO_Click(3, 96);    //S314,S315
                    } while ((int)DI_Check(3) == 96);
                }
                else if(cbxPowerFactor.Text == "0.7")
                {
                    ...
                    do
                    {
                        DO_Click(4, 3);    //S317,S318
                    } while ((int)DI_Check(4) == 3);
        ...
        private void cbxValueRange_TextUpdate(object sender, EventArgs e)
        {
            if (cbxValueRange.Text == "+/- 5A" || cbxValueRange.Text == "+/- 10A")
            {
                cbxChannelCount.Text = "1";
            }
            else if (cbxValueRange.Text == "+/- 50A")
            {
                cbxChannelCount.Text = "2";
            }
            else if (cbxValueRange.Text == "+/- 200A")
            {
                cbxChannelCount.Text = "3";
            }
        }
